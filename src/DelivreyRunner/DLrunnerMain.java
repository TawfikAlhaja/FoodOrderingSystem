...
public class DLrunnerMain extends javax.swing.JFrame {
...
private void makeButtonTransparent(JButton button) {
    ...
    private void initComponents() {
        ...
        jLabelName.setText("DL Runner Name");
...
private void resetButtonColorsExcept(JButton selectedButton) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLrunnerMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DLrunnerMain().setVisible(true);
            }
        });
    }
